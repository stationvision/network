...
//{
//    public class TestHosted : IHostedService
//    {

//        private Timer? _timer = null;

//        public TestHosted(IServiceProvider serviceProvider)
//        {
...
//            {
//                var _messageEntityrepository = scope.ServiceProvider.GetRequiredService<IRepository<MessageEntity>>();
//                var _pulsrepository = scope.ServiceProvider.GetRequiredService<IRepository<Puls>>();
//                var _clientPulsrepository = scope.ServiceProvider.GetRequiredService<IRepository<ClientPuls>>();
...
//                    var buffermessages = _messageEntityrepository.Query(x => x.Status == Enums.MessageStatus.Pending).OrderBy(x => x.PulsData).FirstOrDefault();
//                    buffermessages = null;
//                    if (buffermessages == null) { return; }
//                    var buffermessagesJson = buffermessages.Content.ToJson();

//                    var MessagePulses = BindClientPuls(buffermessages, _pulsrepository, _clientPulsrepository);
...
//                        }
//                        var latestPuls = _clientPulsrepository.Query(x => x.BoardId == buffermessages.BoardId && x.PulsId == Newpuls.PulsId).IncludeMultiple(i => i.Board, i => i.puls).OrderByDescending(x => x.Timestamp).FirstOrDefault();
...
//                            CreateNewClientPulsRecord(Newpuls, _clientPulsrepository);
//                            MovePulsToProcessed(buffermessages, _messageEntityrepository);
//                            continue;
//                        }
...
//                            UpdateLatestClientPulsStartDate(latestPuls, _clientPulsrepository);
//                            MovePulsToProcessed(buffermessages, _messageEntityrepository);
...
//                                    }
//                                    IFDeviationDiffrenceLessThanIgnorableduration(Newpuls, latestPuls, _clientPulsrepository, newPulsRange, latestPulsRange, _requireDataDto, buffermessages, _messageEntityrepository);
//                                    continue;
//                                }
//                            }
//                            else
...
//            IRepository<ClientPuls> clientPulsRepository, ValidationResultItem newPulsRange, ValidationResultItem latestPulsRange, RequireDataDto requireDataDto, MessageEntity buffermessages, IRepository<MessageEntity> _messageEntityrepository)
//        {
...
//            if (requireDataDto.DeviationTime < latestPulsRange.IgnoredDurationThreshold)
//            {
...
//        }
//        void MovePulsToProcessed(MessageEntity messageEntity, IRepository<MessageEntity> repository)
//        {
//            messageEntity.Status = Enums.MessageStatus.Processed;
//            repository.Update(messageEntity);
